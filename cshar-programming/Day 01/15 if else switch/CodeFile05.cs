...
/* For fall thought from one case lable to another 
the case must be empty.

* default must end with the break;
* 
* default block can be located anywhere within the switch case construct
* It is executed when the matching case is not found.
*/